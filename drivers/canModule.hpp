...
public:
            ...
            m_handle(handle), m_label(label)
    {
        ...
        m_callbacks = std::map<CAN::Irq, std::function<void()>>( {
                { CAN::Irq::TxMailboxEmpty, {} }, {
                        CAN::Irq::Fifo0MessagePending, {} },
                { CAN::Irq::Fifo0Full, {} }, { CAN::Irq::Fifo0Overrun, {} }, {
                        CAN::Irq::Fifo1MessagePending, {} },
                { CAN::Irq::Fifo1Full, {} }, { CAN::Irq::Fifo1Overrun, {} }, {
                        CAN::Irq::Wakeup, {} },
                { CAN::Irq::SleepAck, {} }, { CAN::Irq::ErrorWarning, {} }, {
                        CAN::Irq::ErrorPassive, {} },
                { CAN::Irq::BusOffError, {} }, { CAN::Irq::LastErrorCode, {} },
                { CAN::Irq::ErrorStatus, {} } });
    ...
    size_t GetNumberOfAvailableFrames() const
    {
        return m_framesReceived.size();
    }
    CAN::Frame ReceiveFrame();
    CAN::Status TransmitFrame(uint32_t addr, const std::vector<uint8_t> &data =
            std::vector<uint8_t>(),
...
private:
    CAN_FilterTypeDef AssertAndConvertFilterStruct(
