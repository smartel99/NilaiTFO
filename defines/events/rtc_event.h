 ...
 */
#ifndef NILAI_EVENTS_RTCEVENT_H
...
{
    RtcEvent() : Event(EventTypes::RTC_Generic, EventCategories::Rtc) {}
    RtcEvent(RTC_HandleTypeDef* rtc, EventTypes t) : Event(t, EventCategories::Rtc), Rtc(rtc) {}
