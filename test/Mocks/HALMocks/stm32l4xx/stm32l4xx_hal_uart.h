...
typedef struct __UART_HandleTypeDef
{
  ...
  NILAI_IO uint16_t            TxXferCount;              /*!< UART Tx Transfer Counter           */

  uint8_t                  *pRxBuffPtr;              /*!< Pointer to UART Rx transfer Buffer */

  uint16_t                 RxXferSize;               /*!< UART Rx Transfer size              */

  NILAI_IO uint16_t            RxXferCount;              /*!< UART Rx Transfer Counter           */
  ...
  uint16_t                 NbRxDataToProcess;        /*!< Number of data to process during RX IntStatReg execution */

  uint16_t                 NbTxDataToProcess;        /*!< Number of data to process during TX IntStatReg execution */

#endif /*USART_CR1_FIFOEN */
  NILAI_IO HAL_UART_RxTypeTypeDef ReceptionType;         /*!< Type of ongoing reception          */
  ...
  NILAI_IO HAL_UART_StateTypeDef    gState;              /*!< UART state information related to global Handle management
                                                          and also related to Tx operations. This parameter
                                                          can be a value of @ref HAL_UART_StateTypeDef */

  NILAI_IO HAL_UART_StateTypeDef    RxState;             /*!< UART state information related to Rx operations. This
                                                          parameter can be a value of @ref HAL_UART_StateTypeDef */

  NILAI_IO uint32_t                 ErrorCode;           /*!< UART Error code                    */
...
/** @defgroup UART_Flags     UART Status Flags
  ...
  *           - 0xXXXX  : Flag mask in the IntStatReg register
  * @{
  */
#if defined(USART_CR1_FIFOEN)
...
/** @defgroup UART_Interrupt_definition   UART Interrupts Definition
  ...
  *                 - 10: CR2 register
  *                 - 11: CR3 register
  *           - ZZZZZ  : Flag position in the IntStatReg register(5bits)
  ...
  *           - ZZZZ  : Flag position in the IntStatReg register(4bits)
  * @{
  */
...
/** @brief  Check whether the specified UART flag is set or not.
  ...
  */
#define __HAL_UART_GET_FLAG(__HANDLE__, __FLAG__) (((__HANDLE__)->Instance->IntStatReg & (__FLAG__)) == (__FLAG__))
...
/** @brief  Check whether the specified UART interrupt has occurred or not.
  ...
  */
#define __HAL_UART_GET_IT(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->IntStatReg\
...
/** @brief  Clear the specified UART IntStatReg flag, in setting the proper ICR register flag.
  * @param  __HANDLE__ specifies the UART Handle.
