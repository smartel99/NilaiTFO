...
#    define ATOMIC_SET_BIT(REG, BIT)                                                               \
        ...
        {                                                                                          \
            ...
            do                                                                                     \
            {                                                                                      \
                val = __LDREXW((NILAI_IO uint32_t*)&(REG)) | (BIT);                                    \
            } while ((__STREXW(val, (NILAI_IO uint32_t*)&(REG))) != 0U);                               \
        } while (0)
...
#    define ATOMIC_MODIFY_REG(REG, CLEARMSK, SETMASK)                                              \
        ...
        {                                                                                          \
            ...
            do                                                                                     \
            {                                                                                      \
                val = (__LDREXW((NILAI_IO uint32_t*)&(REG)) & ~(CLEARMSK)) | (SETMASK);                \
            } while ((__STREXW(val, (NILAI_IO uint32_t*)&(REG))) != 0U);                               \
        } while (0)
...
#    define ATOMIC_SETH_BIT(REG, BIT)                                                              \
        ...
        {                                                                                          \
            ...
            do                                                                                     \
            {                                                                                      \
                val = __LDREXH((NILAI_IO uint16_t*)&(REG)) | (BIT);                                    \
            } while ((__STREXH(val, (NILAI_IO uint16_t*)&(REG))) != 0U);                               \
        } while (0)
...
#    define ATOMIC_MODIFYH_REG(REG, CLEARMSK, SETMASK)                                             \
        ...
        {                                                                                          \
            ...
            do                                                                                     \
            {                                                                                      \
                val = (__LDREXH((NILAI_IO uint16_t*)&(REG)) & ~(CLEARMSK)) | (SETMASK);                \
            } while ((__STREXH(val, (NILAI_IO uint16_t*)&(REG))) != 0U);                               \
        } while (0)
#endif
...
#    define ATOMIC_SET_BIT(REG, BIT)                                                               \
        do                                                                                         \
        {                                                                                          \
            uint32_t val = __atomic_load_n((NILAI_IO uint32_t*)&(REG), __ATOMIC_RELAXED) | (BIT);      \
            __atomic_store_n((NILAI_IO uint32_t*)&(REG), val);                                         \
        } while (0)
...
#    define ATOMIC_MODIFY_REG(REG, CLEARMSK, SETMASK)                                              \
        ...
        {                                                                                          \
            uint32_t val =                                                                         \
              __atomic_load_n((NILAI_IO uint32_t*)&(REG), __ATOMIC_RELAXED) & ~(CLEARMASK) |           \
              (SETMASK);                                                                           \
            __atomic_store_n((NILAI_IO uint32_t*)&(REG), val);                                         \
        } while (0)
...
#    define ATOMIC_SETH_BIT(REG, BIT)                                                              \
        do                                                                                         \
        {                                                                                          \
            uint16_t val = __atomic_load_n((NILAI_IO uint16_t*)&(REG), __ATOMIC_RELAXED) | (BIT);      \
            __atomic_store_n((NILAI_IO uint16_t*)&(REG), val);                                         \
        } while (0)
...
#    define ATOMIC_MODIFYH_REG(REG, CLEARMSK, SETMASK)                                             \
        ...
        {                                                                                          \
            uint16_t val =                                                                         \
              __atomic_load_n((NILAI_IO uint16_t*)&(REG), __ATOMIC_RELAXED) & ~(CLEARMASK) |           \
              (SETMASK);                                                                           \
            __atomic_store_n((NILAI_IO uint16_t*)&(REG), val);                                         \
        } while (0)

#    define __CLZ(VAL)        __builtin_ctz(VAL)
#    define __RBIT(VAL)       (VAL)
