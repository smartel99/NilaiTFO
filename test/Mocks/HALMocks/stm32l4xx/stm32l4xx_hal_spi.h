...
typedef struct __SPI_HandleTypeDef
{
  ...
  NILAI_IO uint16_t              TxXferCount;    /*!< SPI Tx Transfer Counter                  */

  uint8_t                    *pRxBuffPtr;    /*!< Pointer to SPI Rx transfer Buffer        */

  uint16_t                   RxXferSize;     /*!< SPI Rx Transfer size                     */

  NILAI_IO uint16_t              RxXferCount;    /*!< SPI Rx Transfer Counter                  */

  uint32_t                   CRCSize;        /*!< SPI CRC size used for the transfer       */

  void (*RxISR)(struct __SPI_HandleTypeDef *hspi);   /*!< function pointer on Rx IntStatReg       */

  void (*TxISR)(struct __SPI_HandleTypeDef *hspi);   /*!< function pointer on Tx IntStatReg       */
  ...
  NILAI_IO HAL_SPI_StateTypeDef  State;          /*!< SPI communication state                  */

  NILAI_IO uint32_t              ErrorCode;      /*!< SPI Error code                           */
...
#define __HAL_SPI_CLEAR_MODFFLAG(__HANDLE__)             \
  do{                                                    \
    NILAI_IO uint32_t tmpreg_modf = 0x00U;                   \
...
#define __HAL_SPI_CLEAR_OVRFLAG(__HANDLE__)        \
  do{                                              \
    NILAI_IO uint32_t tmpreg_ovr = 0x00U;              \
...
#define __HAL_SPI_CLEAR_FREFLAG(__HANDLE__)        \
  do{                                              \
    NILAI_IO uint32_t tmpreg_fre = 0x00U;              \
