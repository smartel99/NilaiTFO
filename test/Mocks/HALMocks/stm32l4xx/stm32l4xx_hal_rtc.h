...
#endif /* (USE_HAL_RTC_REGISTER_CALLBACKS) */
{
  ...
  NILAI_IO HAL_RTCStateTypeDef  State;      /*!< Time communication state */
...
#else
#define __HAL_RTC_ALARM_GET_IT(__HANDLE__, __INTERRUPT__) (((((__HANDLE__)->Instance->IntStatReg)& (__INTERRUPT__ >> 4)) != 0U)? 1U : 0U)
#endif
/**
...
/**
  ...
  * @retval None
  */
#define __HAL_RTC_ALARM_GET_FLAG(__HANDLE__, __FLAG__)  (((((__HANDLE__)->Instance->IntStatReg) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif /* #if defined(STM32L412xx) || defined(STM32L422xx) || defined (STM32L4P5xx) || defined (STM32L4Q5xx) */
...
#else
#define __HAL_RTC_ALARM_CLEAR_FLAG(__HANDLE__, __FLAG__)  ((__HANDLE__)->Instance->IntStatReg = (~((__FLAG__) | RTC_ISR_INIT)|((__HANDLE__)->Instance->IntStatReg & RTC_ISR_INIT)))
#endif
