...
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
{
  ...
  NILAI_IO HAL_TIM_StateTypeDef          State;             /*!< TIM operation state                               */
  NILAI_IO HAL_TIM_ChannelStateTypeDef   ChannelState[6];   /*!< TIM channel operation state                       */
  NILAI_IO HAL_TIM_ChannelStateTypeDef   ChannelNState[4];  /*!< TIM complementary channel operation state         */
  NILAI_IO HAL_TIM_DMABurstStateTypeDef  DMABurstState;     /*!< DMA burst operation state                         */
