...
typedef struct
{
  ...
  NILAI_IO uint32_t               ErrorCode;         /* FLASH error code */
  NILAI_IO FLASH_ProcedureTypeDef ProcedureOnGoing;  /* Internal variable to indicate which procedure is ongoing or not in IT context */
  NILAI_IO uint32_t               Address;           /* Internal variable to save address selected for program in IT context */
  NILAI_IO uint32_t               Bank;              /* Internal variable to save current bank selected during erase in IT context */
  NILAI_IO uint32_t               Page;              /* Internal variable to define the current page which is erasing in IT context */
  NILAI_IO uint32_t               NbPagesToErase;    /* Internal variable to save the remaining pages to erase in IT context */
  NILAI_IO FLASH_CacheTypeDef     CacheToReactivate; /* Internal variable to indicate which caches should be reactivated */
