...
#else
#define __HAL_RTC_WAKEUPTIMER_GET_IT(__HANDLE__, __INTERRUPT__)       (((((__HANDLE__)->Instance->IntStatReg) & ((__INTERRUPT__) >> 4)) != 0U) ? 1U : 0U)
#endif
...
#else
#define __HAL_RTC_WAKEUPTIMER_GET_FLAG(__HANDLE__, __FLAG__)   (((((__HANDLE__)->Instance->IntStatReg) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif
...
#else
#define __HAL_RTC_WAKEUPTIMER_CLEAR_FLAG(__HANDLE__, __FLAG__) ((__HANDLE__)->Instance->IntStatReg) = (~((__FLAG__) | RTC_ISR_INIT)|((__HANDLE__)->Instance->IntStatReg & RTC_ISR_INIT))
#endif
...
#else
#define __HAL_RTC_TIMESTAMP_GET_IT(__HANDLE__, __INTERRUPT__)        (((((__HANDLE__)->Instance->IntStatReg) & ((__INTERRUPT__) >> 4)) != 0U) ? 1U : 0U)
#endif
/**
...
#else
#define __HAL_RTC_TIMESTAMP_GET_FLAG(__HANDLE__, __FLAG__)     (((((__HANDLE__)->Instance->IntStatReg) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif
...
#else
#define __HAL_RTC_TIMESTAMP_CLEAR_FLAG(__HANDLE__, __FLAG__)   ((__HANDLE__)->Instance->IntStatReg) = (~((__FLAG__) | RTC_ISR_INIT)|((__HANDLE__)->Instance->IntStatReg & RTC_ISR_INIT))
#endif
...
#else
#define __HAL_RTC_INTERNAL_TIMESTAMP_GET_FLAG(__HANDLE__, __FLAG__)    (((((__HANDLE__)->Instance->IntStatReg) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif
...
#else
#define __HAL_RTC_INTERNAL_TIMESTAMP_CLEAR_FLAG(__HANDLE__, __FLAG__)  ((__HANDLE__)->Instance->IntStatReg) = (~((__FLAG__) | RTC_ISR_INIT)|((__HANDLE__)->Instance->IntStatReg & RTC_ISR_INIT))
#endif
...
#else
#define __HAL_RTC_SHIFT_GET_FLAG(__HANDLE__, __FLAG__)         (((((__HANDLE__)->Instance->IntStatReg) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif
...
#else /* #if defined(STM32L412xx) || defined(STM32L422xx) || defined (STM32L4P5xx) || defined (STM32L4Q5xx) */
#define __HAL_RTC_TAMPER_GET_IT(__HANDLE__, __INTERRUPT__)     (((((__HANDLE__)->Instance->IntStatReg) & (__INTERRUPT__)) != 0U) ? 1U : 0U)
#endif /* #if defined(STM32L412xx) || defined(STM32L422xx) || defined (STM32L4P5xx) || defined (STM32L4Q5xx) */
/**
...
#else
#define __HAL_RTC_TAMPER_GET_FLAG(__HANDLE__, __FLAG__)        (((((__HANDLE__)->Instance->IntStatReg) & (__FLAG__)) != 0U) ? 1U : 0U)
#endif
/**
...
#else
#define __HAL_RTC_TAMPER_CLEAR_FLAG(__HANDLE__, __FLAG__)      ((__HANDLE__)->Instance->IntStatReg) = (~((__FLAG__) | RTC_ISR_INIT)|((__HANDLE__)->Instance->IntStatReg & RTC_ISR_INIT))
#endif
