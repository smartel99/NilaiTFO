...
#define __ADC_PTR_REG_OFFSET(__REG__, __REG_OFFFSET__)                         \
  (( size_t *)((size_t) ((size_t)(&(__REG__)) + ((__REG_OFFFSET__) << 2UL))))
...
typedef struct
{
  size_t CommonClock;                 /*!< Set parameter common to several ADC: Clock source and prescaler.
  ...
  size_t Multimode;                   /*!< Set ADC multimode configuration to operate in independent mode or multimode (for devices with several ADC instances).
  ...
  size_t MultiDMATransfer;            /*!< Set ADC multimode conversion data transfer: no transfer or transfer by DMA.
  ...
  size_t MultiTwoSamplingDelay;       /*!< Set ADC multimode delay between 2 sampling phases.
...
typedef struct
{
  size_t Resolution;                  /*!< Set ADC resolution.
                                             This parameter can be a value of @ref ADC_LL_EC_RESOLUTION

                                             This feature can be modified afterwards using unitary function @ref LL_ADC_SetResolution(). */

  size_t DataAlignment;               /*!< Set ADC conversion data alignment.
                                             This parameter can be a value of @ref ADC_LL_EC_DATA_ALIGN

                                             This feature can be modified afterwards using unitary function @ref LL_ADC_SetDataAlignment(). */

  size_t LowPowerMode;                /*!< Set ADC low power mode.
...
typedef struct
{
  size_t TriggerSource;               /*!< Set ADC group regular conversion trigger source: internal (SW start) or from external peripheral (timer event, external interrupt line).
  ...
  size_t SequencerLength;             /*!< Set ADC group regular sequencer length.
                                             This parameter can be a value of @ref ADC_LL_EC_REG_SEQ_SCAN_LENGTH

                                             This feature can be modified afterwards using unitary function @ref LL_ADC_REG_SetSequencerLength(). */

  size_t SequencerDiscont;            /*!< Set ADC group regular sequencer discontinuous mode: sequence subdivided and scan conversions interrupted every selected number of ranks.
  ...
  size_t ContinuousMode;              /*!< Set ADC continuous conversion mode on ADC group regular, whether ADC conversions are performed in single mode (one conversion per trigger) or in continuous mode (after the first trigger, following conversions launched successively automatically).
                                             This parameter can be a value of @ref ADC_LL_EC_REG_CONTINUOUS_MODE
                                             Note: It is not possible to enable both ADC group regular continuous mode and discontinuous mode.

                                             This feature can be modified afterwards using unitary function @ref LL_ADC_REG_SetContinuousMode(). */

  size_t DMATransfer;                 /*!< Set ADC group regular conversion data transfer: no transfer or transfer by DMA, and DMA requests mode.
                                             This parameter can be a value of @ref ADC_LL_EC_REG_DMA_TRANSFER

                                             This feature can be modified afterwards using unitary function @ref LL_ADC_REG_SetDMATransfer(). */

  size_t Overrun;                     /*!< Set ADC group regular behavior in case of overrun:
...
typedef struct
{
  size_t TriggerSource;               /*!< Set ADC group injected conversion trigger source: internal (SW start) or from external peripheral (timer event, external interrupt line).
  ...
  size_t SequencerLength;             /*!< Set ADC group injected sequencer length.
                                             This parameter can be a value of @ref ADC_LL_EC_INJ_SEQ_SCAN_LENGTH

                                             This feature can be modified afterwards using unitary function @ref LL_ADC_INJ_SetSequencerLength(). */

  size_t SequencerDiscont;            /*!< Set ADC group injected sequencer discontinuous mode: sequence subdivided and scan conversions interrupted every selected number of ranks.
  ...
  size_t TrigAuto;                    /*!< Set ADC group injected conversion trigger: independent or from ADC group regular.
...
#define __LL_ADC_CHANNEL_TO_DECIMAL_NB(__CHANNEL__)                                        \
  ((((__CHANNEL__) & ADC_CHANNEL_ID_BITFIELD_MASK) == 0UL) ?                               \
   ...
   :                                                                                       \
   (                                                                                       \
       (size_t)POSITION_VAL((__CHANNEL__))                                               \
   )                                                                                       \
  )
...
#define __LL_ADC_CALC_VREFANALOG_VOLTAGE(__VREFINT_ADC_DATA__,\
                                         __ADC_RESOLUTION__)                 \
(((size_t)(*VREFINT_CAL_ADDR) * VREFINT_CAL_VREF)                          \
...
/**
  ...
  */
#if defined(ADC_MULTIMODE_SUPPORT)
 size_t LL_ADC_DMA_GetRegAddr(ADC_TypeDef *ADCx, size_t Register)
{
  size_t data_reg_addr;

  if (Register == LL_ADC_DMA_REG_REGULAR_DATA)
  {
    /* Retrieve address of register DR */
    data_reg_addr = (size_t) &(ADCx->DR);
  }
  else /* (Register == LL_ADC_DMA_REG_REGULAR_DATA_MULTI) */
  {
    /* Retrieve address of register CDR */
    data_reg_addr = (size_t) &((__LL_ADC_COMMON_INSTANCE(ADCx))->CDR);
  }
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetCommonClock(ADC_Common_TypeDef *ADCxy_COMMON, size_t CommonClock)
{
...
/**
  ...
  *         @arg @ref LL_ADC_CLOCK_ASYNC_DIV256
  */
 size_t LL_ADC_GetCommonClock(ADC_Common_TypeDef *ADCxy_COMMON)
{
  return (size_t)(READ_BIT(ADCxy_COMMON->CCR, ADC_CCR_CKMODE | ADC_CCR_PRESC));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetCommonPathInternalCh(ADC_Common_TypeDef *ADCxy_COMMON, size_t PathInternal)
{
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetCommonPathInternalChAdd(ADC_Common_TypeDef *ADCxy_COMMON, size_t PathInternal)
{
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetCommonPathInternalChRem(ADC_Common_TypeDef *ADCxy_COMMON, size_t PathInternal)
{
...
/**
  ...
  *         @arg @ref LL_ADC_PATH_INTERNAL_VBAT
  */
 size_t LL_ADC_GetCommonPathInternalCh(ADC_Common_TypeDef *ADCxy_COMMON)
{
  return (size_t)(READ_BIT(ADCxy_COMMON->CCR, ADC_CCR_VREFEN | ADC_CCR_TSEN | ADC_CCR_VBATEN));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetCalibrationFactor(ADC_TypeDef *ADCx, size_t SingleDiff, size_t CalibrationFactor)
{
...
/**
  ...
  */
 size_t LL_ADC_GetCalibrationFactor(ADC_TypeDef *ADCx, size_t SingleDiff)
{
  /* Retrieve bits with position in register depending on parameter           */
  /* "SingleDiff".                                                            */
  /* Parameter used with mask "ADC_SINGLEDIFF_CALIB_FACTOR_MASK" because      */
  /* containing other bits reserved for other purpose.                        */
  return (size_t)(READ_BIT(ADCx->CALFACT,
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetResolution(ADC_TypeDef *ADCx, size_t Resolution)
{
...
/**
  ...
  *         @arg @ref LL_ADC_RESOLUTION_6B
  */
 size_t LL_ADC_GetResolution(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_RES));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetDataAlignment(ADC_TypeDef *ADCx, size_t DataAlignment)
{
...
/**
  ...
  *         @arg @ref LL_ADC_DATA_ALIGN_LEFT
  */
 size_t LL_ADC_GetDataAlignment(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_ALIGN));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetLowPowerMode(ADC_TypeDef *ADCx, size_t LowPowerMode)
{
...
/**
  ...
  *         @arg @ref LL_ADC_LP_AUTOWAIT
  */
 size_t LL_ADC_GetLowPowerMode(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_AUTDLY));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetOffset(ADC_TypeDef *ADCx, size_t Offsety, size_t Channel, size_t OffsetLevel)
{
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
...
/**
  ...
  *                      using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
  */
 size_t LL_ADC_GetOffsetChannel(ADC_TypeDef *ADCx, size_t Offsety)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);

  return (size_t) READ_BIT(*preg, ADC_OFR1_OFFSET1_CH);
}
...
/**
  ...
  * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
  */
 size_t LL_ADC_GetOffsetLevel(ADC_TypeDef *ADCx, size_t Offsety)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);

  return (size_t) READ_BIT(*preg, ADC_OFR1_OFFSET1);
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetOffsetState(ADC_TypeDef *ADCx, size_t Offsety, size_t OffsetState)
{
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
...
/**
  ...
  *         @arg @ref LL_ADC_OFFSET_ENABLE
  */
 size_t LL_ADC_GetOffsetState(ADC_TypeDef *ADCx, size_t Offsety)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);

  return (size_t) READ_BIT(*preg, ADC_OFR1_OFFSET1_EN);
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetSamplingTimeCommonConfig(ADC_TypeDef *ADCx, size_t SamplingTimeCommonConfig)
{
...
/**
  ...
  *         @arg @ref LL_ADC_SAMPLINGTIME_COMMON_3C5_REPL_2C5
  */
 size_t LL_ADC_GetSamplingTimeCommonConfig(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->SMPR1, ADC_SMPR1_SMPPLUS));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetTriggerSource(ADC_TypeDef *ADCx, size_t TriggerSource)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_TRIG_EXT_EXTI_LINE11
  */
 size_t LL_ADC_REG_GetTriggerSource(ADC_TypeDef *ADCx)
{
   size_t TriggerSource = READ_BIT(ADCx->CFGR, ADC_CFGR_EXTSEL | ADC_CFGR_EXTEN);

  /* Value for shift of {0; 4; 8; 12} depending on value of bitfield          */
  /* corresponding to ADC_CFGR_EXTEN {0; 1; 2; 3}.                            */
  size_t ShiftExten = ((TriggerSource & ADC_CFGR_EXTEN) >> (ADC_REG_TRIG_EXTEN_BITOFFSET_POS - 2UL));
...
/**
  ...
  */
 size_t LL_ADC_REG_IsTriggerSourceSWStart(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetTriggerEdge(ADC_TypeDef *ADCx, size_t ExternalTriggerEdge)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_TRIG_EXT_RISINGFALLING
  */
 size_t LL_ADC_REG_GetTriggerEdge(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_EXTEN));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetSequencerLength(ADC_TypeDef *ADCx, size_t SequencerNbRanks)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_SEQ_SCAN_ENABLE_16RANKS
  */
 size_t LL_ADC_REG_GetSequencerLength(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->SQR1, ADC_SQR1_L));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetSequencerDiscont(ADC_TypeDef *ADCx, size_t SeqDiscont)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_SEQ_DISCONT_8RANKS
  */
 size_t LL_ADC_REG_GetSequencerDiscont(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_DISCEN | ADC_CFGR_DISCNUM));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetSequencerRanks(ADC_TypeDef *ADCx, size_t Rank, size_t Channel)
{
  /* Set bits with content of parameter "Channel" with bits position          */
  /* in register and register position depending on parameter "Rank".         */
  /* Parameters "Rank" and "Channel" are used with masks because containing   */
  /* other bits reserved for other purpose.                                   */
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->SQR1, ((Rank & ADC_REG_SQRX_REGOFFSET_MASK) >> ADC_SQRX_REGOFFSET_POS));
...
/**
  ...
  *                      using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
  */
 size_t LL_ADC_REG_GetSequencerRanks(ADC_TypeDef *ADCx, size_t Rank)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->SQR1, ((Rank & ADC_REG_SQRX_REGOFFSET_MASK) >> ADC_SQRX_REGOFFSET_POS));

  return (size_t)((READ_BIT(*preg,
                              ADC_CHANNEL_ID_NUMBER_MASK_POSBIT0 << (Rank & ADC_REG_RANK_ID_SQRX_MASK))
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetContinuousMode(ADC_TypeDef *ADCx, size_t Continuous)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_CONV_CONTINUOUS
  */
 size_t LL_ADC_REG_GetContinuousMode(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_CONT));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetDMATransfer(ADC_TypeDef *ADCx, size_t DMATransfer)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_DMA_TRANSFER_UNLIMITED
  */
 size_t LL_ADC_REG_GetDMATransfer(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_DMAEN | ADC_CFGR_DMACFG));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetDFSDMTransfer(ADC_TypeDef *ADCx, size_t DFSDMTransfer)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_DFSDM_TRANSFER_ENABLE
  */
 size_t LL_ADC_REG_GetDFSDMTransfer(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_DFSDMCFG));
}
#endif /* ADC_CFGR_DFSDMCFG */
...
/**
  ...
  * @retval None
  */
 void LL_ADC_REG_SetOverrun(ADC_TypeDef *ADCx, size_t Overrun)
{
...
/**
  ...
  *         @arg @ref LL_ADC_REG_OVR_DATA_OVERWRITTEN
  */
 size_t LL_ADC_REG_GetOverrun(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_OVRMOD));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetTriggerSource(ADC_TypeDef *ADCx, size_t TriggerSource)
{
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_TRIG_EXT_EXTI_LINE15
  */
 size_t LL_ADC_INJ_GetTriggerSource(ADC_TypeDef *ADCx)
{
   size_t TriggerSource = READ_BIT(ADCx->JSQR, ADC_JSQR_JEXTSEL | ADC_JSQR_JEXTEN);

  /* Value for shift of {0; 4; 8; 12} depending on value of bitfield          */
  /* corresponding to ADC_JSQR_JEXTEN {0; 1; 2; 3}.                           */
  size_t ShiftJexten = ((TriggerSource & ADC_JSQR_JEXTEN) >> (ADC_INJ_TRIG_EXTEN_BITOFFSET_POS - 2UL));
...
/**
  ...
  *         Value "1" if trigger source SW start.
  */
 size_t LL_ADC_INJ_IsTriggerSourceSWStart(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetTriggerEdge(ADC_TypeDef *ADCx, size_t ExternalTriggerEdge)
{
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_TRIG_EXT_RISINGFALLING
  */
 size_t LL_ADC_INJ_GetTriggerEdge(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->JSQR, ADC_JSQR_JEXTEN));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetSequencerLength(ADC_TypeDef *ADCx, size_t SequencerNbRanks)
{
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_SEQ_SCAN_ENABLE_4RANKS
  */
 size_t LL_ADC_INJ_GetSequencerLength(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->JSQR, ADC_JSQR_JL));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetSequencerDiscont(ADC_TypeDef *ADCx, size_t SeqDiscont)
{
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_SEQ_DISCONT_1RANK
  */
 size_t LL_ADC_INJ_GetSequencerDiscont(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_JDISCEN));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetSequencerRanks(ADC_TypeDef *ADCx, size_t Rank, size_t Channel)
{
  /* Set bits with content of parameter "Channel" with bits position          */
...
/**
  ...
  *                      using helper macro @ref __LL_ADC_CHANNEL_INTERNAL_TO_EXTERNAL().
  */
 size_t LL_ADC_INJ_GetSequencerRanks(ADC_TypeDef *ADCx, size_t Rank)
{
  return (size_t)((READ_BIT(ADCx->JSQR,
                              (ADC_CHANNEL_ID_NUMBER_MASK >> ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS) << (Rank & ADC_INJ_RANK_ID_JSQR_MASK))
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetTrigAuto(ADC_TypeDef *ADCx, size_t TrigAuto)
{
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_TRIG_FROM_GRP_REGULAR
  */
 size_t LL_ADC_INJ_GetTrigAuto(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_JAUTO));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_INJ_SetQueueMode(ADC_TypeDef *ADCx, size_t QueueMode)
{
...
/**
  ...
  *         @arg @ref LL_ADC_INJ_QUEUE_2CONTEXTS_END_EMPTY
  */
 size_t LL_ADC_INJ_GetQueueMode(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR, ADC_CFGR_JQM | ADC_CFGR_JQDIS));
}
...
/**
 ...
 void LL_ADC_INJ_ConfigQueueContext(ADC_TypeDef *ADCx,
                                                   size_t TriggerSource,
                                                   size_t ExternalTriggerEdge,
                                                   size_t SequencerNbRanks,
                                                   size_t Rank1_Channel,
                                                   size_t Rank2_Channel,
                                                   size_t Rank3_Channel,
                                                   size_t Rank4_Channel)
{
  ...
  size_t is_trigger_not_sw = (size_t)((TriggerSource != LL_ADC_INJ_TRIG_SOFTWARE) ? 1UL : 0UL);
  MODIFY_REG(ADCx->JSQR,
             ADC_JSQR_JEXTSEL |
             ADC_JSQR_JEXTEN  |
             ADC_JSQR_JSQ4    |
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetChannelSamplingTime(ADC_TypeDef *ADCx, size_t Channel, size_t SamplingTime)
{
  /* Set bits with content of parameter "SamplingTime" with bits position     */
  /* in register and register position depending on parameter "Channel".      */
  /* Parameter "Channel" is used with masks because containing                */
  /* other bits reserved for other purpose.                                   */
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->SMPR1, ((Channel & ADC_CHANNEL_SMPRX_REGOFFSET_MASK) >> ADC_SMPRX_REGOFFSET_POS));
...
/**
  ...
  *             Refer to function @ref LL_ADC_SetSamplingTimeCommonConfig().
  */
 size_t LL_ADC_GetChannelSamplingTime(ADC_TypeDef *ADCx, size_t Channel)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->SMPR1, ((Channel & ADC_CHANNEL_SMPRX_REGOFFSET_MASK) >> ADC_SMPRX_REGOFFSET_POS));
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetChannelSingleDiff(ADC_TypeDef *ADCx, size_t Channel, size_t SingleDiff)
{
...
/**
  ...
  */
 size_t LL_ADC_GetChannelSingleDiff(ADC_TypeDef *ADCx, size_t Channel)
{
  return (size_t)(READ_BIT(ADCx->DIFSEL, (Channel & ADC_SINGLEDIFF_CHANNEL_MASK)));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetAnalogWDMonitChannels(ADC_TypeDef *ADCx, size_t AWDy, size_t AWDChannelGroup)
{
  /* Set bits with content of parameter "AWDChannelGroup" with bits position  */
  /* in register and register position depending on parameter "AWDy".         */
  /* Parameters "AWDChannelGroup" and "AWDy" are used with masks because      */
  /* containing other bits reserved for other purpose.                        */
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->CFGR, ((AWDy & ADC_AWD_CRX_REGOFFSET_MASK) >> ADC_AWD_CRX_REGOFFSET_POS)
...
/**
  ...
  *         (0) On STM32L4, parameter available only on analog watchdog number: AWD1.
  */
 size_t LL_ADC_GetAnalogWDMonitChannels(ADC_TypeDef *ADCx, size_t AWDy)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->CFGR, ((AWDy & ADC_AWD_CRX_REGOFFSET_MASK) >> ADC_AWD_CRX_REGOFFSET_POS)
                                                   + ((AWDy & ADC_AWD_CR12_REGOFFSETGAP_MASK) * ADC_AWD_CR12_REGOFFSETGAP_VAL));

  size_t AnalogWDMonitChannels = (READ_BIT(*preg, AWDy) & ADC_AWD_CR_ALL_CHANNEL_MASK);
...
/**
  ...
  * @retval None
  */
 void LL_ADC_ConfigAnalogWDThresholds(ADC_TypeDef *ADCx, size_t AWDy, size_t AWDThresholdHighValue,
                                                     size_t AWDThresholdLowValue)
{
  ...
  /* containing other bits reserved for other purpose.                        */
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->TR1, ((AWDy & ADC_AWD_TRX_REGOFFSET_MASK) >> ADC_AWD_TRX_REGOFFSET_POS));
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetAnalogWDThresholds(ADC_TypeDef *ADCx, size_t AWDy, size_t AWDThresholdsHighLow,
                                                  size_t AWDThresholdValue)
{
  ...
  /* containing other bits reserved for other purpose.                        */
   size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->TR1,
...
/**
  ...
  * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
  */
 size_t LL_ADC_GetAnalogWDThresholds(ADC_TypeDef *ADCx, size_t AWDy, size_t AWDThresholdsHighLow)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->TR1,
                                                   ((AWDy & ADC_AWD_TRX_REGOFFSET_MASK) >> ADC_AWD_TRX_REGOFFSET_POS));
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetOverSamplingScope(ADC_TypeDef *ADCx, size_t OvsScope)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_GRP_INJ_REG_RESUMED
  */
 size_t LL_ADC_GetOverSamplingScope(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR2, ADC_CFGR2_ROVSE | ADC_CFGR2_JOVSE | ADC_CFGR2_ROVSM));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetOverSamplingDiscont(ADC_TypeDef *ADCx, size_t OverSamplingDiscont)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_REG_DISCONT
  */
 size_t LL_ADC_GetOverSamplingDiscont(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR2, ADC_CFGR2_TROVS));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_ConfigOverSamplingRatioShift(ADC_TypeDef *ADCx, size_t Ratio, size_t Shift)
{
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_RATIO_256
  */
 size_t LL_ADC_GetOverSamplingRatio(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR2, ADC_CFGR2_OVSR));
}
...
/**
  ...
  *         @arg @ref LL_ADC_OVS_SHIFT_RIGHT_8
  */
 size_t LL_ADC_GetOverSamplingShift(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->CFGR2, ADC_CFGR2_OVSS));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetMultimode(ADC_Common_TypeDef *ADCxy_COMMON, size_t Multimode)
{
...
/**
  ...
  *         @arg @ref LL_ADC_MULTI_DUAL_REG_INT_INJ_SIM
  */
 size_t LL_ADC_GetMultimode(ADC_Common_TypeDef *ADCxy_COMMON)
{
  return (size_t)(READ_BIT(ADCxy_COMMON->CCR, ADC_CCR_DUAL));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetMultiDMATransfer(ADC_Common_TypeDef *ADCxy_COMMON, size_t MultiDMATransfer)
{
...
/**
  ...
  *         @arg @ref LL_ADC_MULTI_REG_DMA_UNLMT_RES8_6B
  */
 size_t LL_ADC_GetMultiDMATransfer(ADC_Common_TypeDef *ADCxy_COMMON)
{
  return (size_t)(READ_BIT(ADCxy_COMMON->CCR, ADC_CCR_MDMA | ADC_CCR_DMACFG));
}
...
/**
  ...
  * @retval None
  */
 void LL_ADC_SetMultiTwoSamplingDelay(ADC_Common_TypeDef *ADCxy_COMMON, size_t MultiTwoSamplingDelay)
{
...
/**
  ...
  *         (3) Parameter available only if ADC resolution is 12 bits.
  */
 size_t LL_ADC_GetMultiTwoSamplingDelay(ADC_Common_TypeDef *ADCxy_COMMON)
{
  return (size_t)(READ_BIT(ADCxy_COMMON->CCR, ADC_CCR_DELAY));
}
#endif /* ADC_MULTIMODE_SUPPORT */
...
/* current functions name.                                                    */
 void LL_ADC_REG_SetTrigSource(ADC_TypeDef *ADCx, size_t TriggerSource)
{
  LL_ADC_REG_SetTriggerSource(ADCx, TriggerSource);
}
 void LL_ADC_INJ_SetTrigSource(ADC_TypeDef *ADCx, size_t TriggerSource)
{
...
/**
  ...
  */
 size_t LL_ADC_IsDeepPowerDownEnabled(ADC_TypeDef *ADCx)
{
...
/**
  ...
  */
 size_t LL_ADC_IsInternalRegulatorEnabled(ADC_TypeDef *ADCx)
{
...
/**
  ...
  */
 size_t LL_ADC_IsEnabled(ADC_TypeDef *ADCx)
{
...
/**
  ...
  */
 size_t LL_ADC_IsDisableOngoing(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval None
  */
 void LL_ADC_StartCalibration(ADC_TypeDef *ADCx, size_t SingleDiff)
{
  /* Note: Write register with some additional bits forced to state reset     */
  /*       instead of modifying only the selected bit for this function,      */
  /*       to not interfere with bits with HW property "rs".                  */
...
/**
  ...
  */
 size_t LL_ADC_IsCalibrationOnGoing(ADC_TypeDef *ADCx)
{
...
/**
  ...
  */
 size_t LL_ADC_REG_IsConversionOngoing(ADC_TypeDef *ADCx)
{
...
/**
  ...
  */
 size_t LL_ADC_REG_IsStopConversionOngoing(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00000000 and Max_Data=0xFFFFFFFF
  */
 size_t LL_ADC_REG_ReadConversionData32(ADC_TypeDef *ADCx)
{
  return (size_t)(READ_BIT(ADCx->DR, ADC_DR_RDATA));
}
...
/**
  ...
  * @retval Value between Min_Data=0x00000000 and Max_Data=0xFFFFFFFF
  */
 size_t LL_ADC_REG_ReadMultiConversionData32(ADC_Common_TypeDef *ADCxy_COMMON, size_t ConversionData)
{
  return (size_t)(READ_BIT(ADCxy_COMMON->CDR,
                             ConversionData)
...
/**
  ...
  */
 size_t LL_ADC_INJ_IsConversionOngoing(ADC_TypeDef *ADCx)
{
...
/**
  ...
  */
 size_t LL_ADC_INJ_IsStopConversionOngoing(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval Value between Min_Data=0x00000000 and Max_Data=0xFFFFFFFF
  */
 size_t LL_ADC_INJ_ReadConversionData32(ADC_TypeDef *ADCx, size_t Rank)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->JDR1, ((Rank & ADC_INJ_JDRX_REGOFFSET_MASK) >> ADC_JDRX_REGOFFSET_POS));
...
/**
  ...
  * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
  */
 uint16_t LL_ADC_INJ_ReadConversionData12(ADC_TypeDef *ADCx, size_t Rank)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->JDR1, ((Rank & ADC_INJ_JDRX_REGOFFSET_MASK) >> ADC_JDRX_REGOFFSET_POS));
...
/**
  ...
  * @retval Value between Min_Data=0x000 and Max_Data=0x3FF
  */
 uint16_t LL_ADC_INJ_ReadConversionData10(ADC_TypeDef *ADCx, size_t Rank)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->JDR1, ((Rank & ADC_INJ_JDRX_REGOFFSET_MASK) >> ADC_JDRX_REGOFFSET_POS));
...
/**
  ...
  * @retval Value between Min_Data=0x00 and Max_Data=0xFF
  */
 uint8_t LL_ADC_INJ_ReadConversionData8(ADC_TypeDef *ADCx, size_t Rank)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->JDR1, ((Rank & ADC_INJ_JDRX_REGOFFSET_MASK) >> ADC_JDRX_REGOFFSET_POS));
...
/**
  ...
  * @retval Value between Min_Data=0x00 and Max_Data=0x3F
  */
 uint8_t LL_ADC_INJ_ReadConversionData6(ADC_TypeDef *ADCx, size_t Rank)
{
  const  size_t *preg = __ADC_PTR_REG_OFFSET(ADCx->JDR1, ((Rank & ADC_INJ_JDRX_REGOFFSET_MASK) >> ADC_JDRX_REGOFFSET_POS));
...
/**
  ...
  *         is enabled and when conversion clock is active.
  *         (not only core clock: this ADC has a dual clock domain)
  * @rmtoll IntStatReg      ADRDY          LL_ADC_IsActiveFlag_ADRDY
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_ADRDY(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_ADRDY) == (LL_ADC_FLAG_ADRDY)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group regular end of unitary conversion.
  * @rmtoll IntStatReg      EOC            LL_ADC_IsActiveFlag_EOC
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_EOC(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, ADC_ISR_EOC) == (ADC_ISR_EOC)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group regular end of sequence conversions.
  * @rmtoll IntStatReg      EOS            LL_ADC_IsActiveFlag_EOS
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_EOS(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_EOS) == (LL_ADC_FLAG_EOS)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group regular overrun.
  * @rmtoll IntStatReg      OVR            LL_ADC_IsActiveFlag_OVR
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_OVR(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_OVR) == (LL_ADC_FLAG_OVR)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group regular end of sampling phase.
  * @rmtoll IntStatReg      EOSMP          LL_ADC_IsActiveFlag_EOSMP
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_EOSMP(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_EOSMP) == (LL_ADC_FLAG_EOSMP)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group injected end of unitary conversion.
  * @rmtoll IntStatReg      JEOC           LL_ADC_IsActiveFlag_JEOC
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_JEOC(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_JEOC) == (LL_ADC_FLAG_JEOC)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group injected end of sequence conversions.
  * @rmtoll IntStatReg      JEOS           LL_ADC_IsActiveFlag_JEOS
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_JEOS(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_JEOS) == (LL_ADC_FLAG_JEOS)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC group injected contexts queue overflow.
  * @rmtoll IntStatReg      JQOVF          LL_ADC_IsActiveFlag_JQOVF
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_JQOVF(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_JQOVF) == (LL_ADC_FLAG_JQOVF)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC analog watchdog 1 flag
  * @rmtoll IntStatReg      AWD1           LL_ADC_IsActiveFlag_AWD1
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_AWD1(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_AWD1) == (LL_ADC_FLAG_AWD1)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC analog watchdog 2.
  * @rmtoll IntStatReg      AWD2           LL_ADC_IsActiveFlag_AWD2
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_AWD2(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_AWD2) == (LL_ADC_FLAG_AWD2)) ? 1UL : 0UL);
}

/**
  * @brief  Get flag ADC analog watchdog 3.
  * @rmtoll IntStatReg      AWD3           LL_ADC_IsActiveFlag_AWD3
  * @param  ADCx ADC instance
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_AWD3(ADC_TypeDef *ADCx)
{
  return ((READ_BIT(ADCx->IntStatReg, LL_ADC_FLAG_AWD3) == (LL_ADC_FLAG_AWD3)) ? 1UL : 0UL);
}
...
/**
  ...
  *         is enabled and when conversion clock is active.
  *         (not only core clock: this ADC has a dual clock domain)
  * @rmtoll IntStatReg      ADRDY          LL_ADC_ClearFlag_ADRDY
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_ADRDY(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_ADRDY);
}

/**
  * @brief  Clear flag ADC group regular end of unitary conversion.
  * @rmtoll IntStatReg      EOC            LL_ADC_ClearFlag_EOC
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_EOC(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_EOC);
}

/**
  * @brief  Clear flag ADC group regular end of sequence conversions.
  * @rmtoll IntStatReg      EOS            LL_ADC_ClearFlag_EOS
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_EOS(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_EOS);
}

/**
  * @brief  Clear flag ADC group regular overrun.
  * @rmtoll IntStatReg      OVR            LL_ADC_ClearFlag_OVR
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_OVR(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_OVR);
}

/**
  * @brief  Clear flag ADC group regular end of sampling phase.
  * @rmtoll IntStatReg      EOSMP          LL_ADC_ClearFlag_EOSMP
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_EOSMP(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_EOSMP);
}

/**
  * @brief  Clear flag ADC group injected end of unitary conversion.
  * @rmtoll IntStatReg      JEOC           LL_ADC_ClearFlag_JEOC
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_JEOC(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_JEOC);
}

/**
  * @brief  Clear flag ADC group injected end of sequence conversions.
  * @rmtoll IntStatReg      JEOS           LL_ADC_ClearFlag_JEOS
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_JEOS(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_JEOS);
}

/**
  * @brief  Clear flag ADC group injected contexts queue overflow.
  * @rmtoll IntStatReg      JQOVF          LL_ADC_ClearFlag_JQOVF
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_JQOVF(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_JQOVF);
}

/**
  * @brief  Clear flag ADC analog watchdog 1.
  * @rmtoll IntStatReg      AWD1           LL_ADC_ClearFlag_AWD1
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_AWD1(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_AWD1);
}

/**
  * @brief  Clear flag ADC analog watchdog 2.
  * @rmtoll IntStatReg      AWD2           LL_ADC_ClearFlag_AWD2
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_AWD2(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_AWD2);
}

/**
  * @brief  Clear flag ADC analog watchdog 3.
  * @rmtoll IntStatReg      AWD3           LL_ADC_ClearFlag_AWD3
  * @param  ADCx ADC instance
  * @retval None
  */
 void LL_ADC_ClearFlag_AWD3(ADC_TypeDef *ADCx)
{
  WRITE_REG(ADCx->IntStatReg, LL_ADC_FLAG_AWD3);
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_ADRDY(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_ADRDY(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_EOC(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_EOC(ADC_Common_TypeDef *ADCxy_COMMON)
{
  return ((READ_BIT(ADCxy_COMMON->CSR, LL_ADC_FLAG_EOC_SLV) == (LL_ADC_FLAG_EOC_SLV)) ? 1UL : 0UL);
}
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_EOS(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_EOS(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_OVR(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_OVR(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_EOSMP(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_EOSMP(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_JEOC(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_JEOC(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_JEOS(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_JEOS(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_JQOVF(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_JQOVF(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_AWD1(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_AWD1(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_AWD2(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_AWD2(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_MST_AWD3(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsActiveFlag_SLV_AWD3(ADC_Common_TypeDef *ADCxy_COMMON)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_ADRDY(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_EOC(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_EOS(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_OVR(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_EOSMP(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_JEOC(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_JEOS(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_JQOVF(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_AWD1(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_AWD2(ADC_TypeDef *ADCx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
 size_t LL_ADC_IsEnabledIT_AWD3(ADC_TypeDef *ADCx)
{
