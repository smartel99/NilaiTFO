...
namespace ADS
{
    ...
    public:
        ...
        InternalReferenceEnable internalReferenceEnable =
                InternalReferenceEnable::Enable;
        NegativeChargePumpEnable negativeChargePumpEnable =
                NegativeChargePumpEnable::Disable;
        ...
        bool operator==(const Config &other) const
        {
            return ((this->pins == other.pins)
                    ...
                    && (this->modulatorClockDivision
                            == other.modulatorClockDivision)
                    ...
                    && (this->internalReferenceEnable
                            == other.internalReferenceEnable)
                    && (this->negativeChargePumpEnable
                            == other.negativeChargePumpEnable)
    ...
    namespace Registers
    {
        ...
        public:
            ...
            AnalogSysConfig(const Config &config)
            {
                ...
                negativeChargePumpEnable = (uint8_t) config
                        .negativeChargePumpEnable;
                doNotUse = 1;
            }
