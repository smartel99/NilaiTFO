...
public:
    ...
    const ADS::Config& GetConfig() const
    {
        return m_config;
    }
    
    const AdsPacket& GetLatestPacket() const
    {
        return m_latestFrame;
    }
    
    float GetChannel1() const
    {
        return m_latestFrame.channel1;
    }
    
    float GetChannel2() const
    {
        return m_latestFrame.channel2;
    }
    
    float GetChannel3() const
    {
        return m_latestFrame.channel3;
    }
    
    float GetChannel4() const
    {
        return m_latestFrame.channel4;
    }
